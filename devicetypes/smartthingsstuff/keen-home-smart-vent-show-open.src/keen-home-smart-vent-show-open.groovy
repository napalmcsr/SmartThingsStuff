...
metadata {
    definition (name: "Keen Home Smart Vent show open", namespace: "SmartThingsStuff", author: "Keen Home, Craig Romei") {
    ...
    tiles {
        ...
        valueTile("CurrentLevel", "device.level", inactiveLabel: false, decoration: "flat") {
        ...
        main "CurrentLevel"
        details(["switch","refresh","temperature","levelSliderControl","battery","CurrentLevel"])
    }
}
